...
= Project: {Smart Home Arduino App}
...
= Features
- Internal Temperature Monitoring: Uses a sensor to read the room temperature.
- External Weather API Integration: Fetches real-time external temperature.
- Electricity Tariff Optimization: Connects to an electricity tariff API for cost-efficient energy 
